 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Xoops_Sniffs_Debug_CodeAnalyzerSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (is_numeric($exitCode) === true && $exitCode > 0) {
            ...
            throw new PHP_CodeSniffer_Exception(_AM_XOOPSSECURE_CODESNIFFER_FAILIZENDCODEAN.
                _AM_XOOPSSECURE_CODESNIFFER_FAILIZENDCODEANEXITCODE.$exitCode.
                _AM_XOOPSSECURE_CODESNIFFER_FAILIZENDCODEANEXITCODERETVAL.$retval.
                _AM_XOOPSSECURE_CODESNIFFER_FAILIZENDCODEANEXITCODEOUTPUT.$output);
        }
