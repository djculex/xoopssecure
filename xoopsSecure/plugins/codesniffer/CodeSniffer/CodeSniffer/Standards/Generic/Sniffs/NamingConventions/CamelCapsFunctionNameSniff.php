    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (preg_match('|^__|', $methodName) !== 0) {
            ...
            if (in_array($magicPart, $this->magicMethods) === false) {
                 $error = _AM_XOOPSSECURE_CODESNIFFER_METHNIIDOUBUND;
        ...
        if (PHP_CodeSniffer::isCamelCaps($methodName, false, true, $this->strict) === false) {
            if ($methodProps['scope_specified'] === true) {
                $error = _AM_XOOPSSECURE_CODESNIFFER_METHNAMENCCF;
                $data  = array(
                ...
                $error = _AM_XOOPSSECURE_CODESNIFFER_METHNAMENICCF;
    ...
    protected function processTokenOutsideScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (preg_match('|^__|', $functionName) !== 0) {
            ...
            if (in_array($magicPart, $this->magicFunctions) === false) {
                 $error = _AM_XOOPSSECURE_CODESNIFFER_FUNCNAMEIIDUND;
        ...
        if (PHP_CodeSniffer::isCamelCaps($functionName, false, true, $this->strict) === false) {
            $error = _AM_XOOPSSECURE_CODESNIFFER_FUNCNAMENICCF;
            $phpcsFile->addError($error, $stackPtr, 'NotCamelCaps', $errorData);
        }
