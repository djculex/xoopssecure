<div class="xoopssecure_system_panel-heading" role="tab" id="headingbackups">
    ...
    <h4 class="xoopssecure_download_iconheader">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsebackups" aria-expanded="true"
           aria-controls="collapsebackups">
    ...
    <div id="collapsebackups" class="xoopssecure_system_collapsediv panel-collapse collapse in" role="tabpanel"
         aria-labelledby="headingbackups">
        <div class="xoopssecure_backup_collapsepanelbody panel-body">
            <div class="row">
                <div class="xoopssecure_dobackup col text-center">
                    <button id="xoopssecure_domanualbackup" type="button"
                            class="xoopssecure_dobackup_action btn btn-primary text-center" data-toggle="button"
            ...
            <table class="table" id="xoopssecure_backup_downloadtable">
                ...
                <{foreach name=loop from=$backupfiles key=id item=i}>
                    <tr id="xoopssecure_trbackup_<{$i.filename}>">
                        ...
                        <td class="size">
                            <a href="<{$xoops_url}>/uploads/backup/<{$i.filename}>">
                                <{$smarty.const.DO_XOOPSSECURE_DOWNLOAD_BACKUPFILEDOWNLOADTEXT}>
                            </a>
                        </td>
                        <td class="delete">
                            <a role="button"
                               ...
                               data-confyes="<{$smarty.const.DO_XOOPSSECURE_CONFIRM_YES}>"
                               data-confno="<{$smarty.const.DO_XOOPSSECURE_CONFIRM_NO}>">
                ...
                <tr id="xoopssecure_trbackup_0">
                    ...
                    <td colspan="4" class="name truncate" style="font-size: 16px;text-align: center;font-weight: bold;">
                        <{$smarty.const.DO_XOOPSSECURE_NOBACKUPYET}>
                    </td>
                    <td class="date"></td>
                </tr>
                <{/if}>
...
<!-- Modal -->
<div class="modal fade" id="xoopssecureBACKUPDoingBackupWaitModal" tabindex="-1"
     aria-labelledby="xoopssecureBACKUPDoingBackupWaitModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="xoopssecureBACKUPDoingBackupWaitModal">
                    <{$smarty.const.DO_XOOPSSECURE_DOINGBACKUP_TITLE}></h1>
            </div>
