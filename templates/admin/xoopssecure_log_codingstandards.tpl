        ...
        <fieldset class="border border-dark rounded" id="<{$arr.filename}>" style="">
            ...
            <div class="container mt-5 px-2">
                ...
                <div id="<{$arr.filename}>" class="Scanfileactionbox">
                    <p>
                        <font size="+0"><{$smarty.const._LOG_XOOPSSECURE_DELETEALLFORFILE}></font>
                        <button data-conftext="<{$lang_log_CONFDELISSUE_TEXT}>"
                                data-confyes="<{$lang_log_CONFYES}>" data-confno="<{$lang_log_CONFNO}>"
                                data-toggle="tooltip"
                                title="If this file is safe remove 'All' issues regarding this file."
                                class="xoopssecuredeleteIssueByFN" id="<{$arr.filename}>"><i
                                    class="fa fa-trash-o"></i></button>
                    </p>
                    <p>
                        <font size="+0"><{$smarty.const._LOG_XOOPSSECURE_IGNORDIR}></font>
                        <button data-conftext="<{$lang_log_CONFOMITDIRS_TEXT}>"
                                data-confyes="<{$lang_log_CONFYES}>" data-confno="<{$lang_log_CONFNO}>"
                                data-toggle="tooltip"
                                title="Delete issues & ignore folder" class="xoopssecureaddToOmitByDirN"
                                id="<{$arr.dirname}>"><i
                                    class="fa fa-unlink"></i></button>
                    </p>
                    <p>
                        <font size="+0"><{$smarty.const._LOG_XOOPSSECURE_DELANDIGNORFILE}></font>
                        <button data-conftext="<{$lang_log_CONFOMITFILE_TEXT}>"
                                data-confyes="<{$lang_log_CONFYES}>" data-confno="<{$lang_log_CONFNO}>"
                                data-toggle="tooltip"
                                title="Don't scan this file again." class="xoopssecureaddToOmitByFN"
                                id="<{$arr.filename}>"><i class="fa fa-ban"></i></button>
                    </p>
                </div>
            </div>
            ...
            <table id="xoopssecureScanDetails" class="table table-sm" cellspacing="0" width="80%">
                ...
                <tr>
                    ...
                    <th scope="col" class="text-center"><{$smarty.const._LOG_XOOPSSECURE_ISSUE_TITLE}></th>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button data-toggle="tooltip" data-issueid="<{$iss.id}>"
                                title="<{$smarty.const._LOG_XOOPSSECURE_TOOLTIP_DELISSUE}>" class="btn"
                                id="xoopssecureLogDeleteIssueByID"><i
                                    class="fa fa-trash-o"></i></button>
                        <button data-id="<{$arr.id}>" data-filename="<{$arr.filename}>"
                                data-linenumber="<{$iss.linenumber}>"
                                data-toggle="tooltip" title="<{$smarty.const._LOG_XOOPSSECURE_TOOLTIP_SHOWSOURCE}>"
                                class="btn" id="xoopssecureLogshowSourceCode"><i
