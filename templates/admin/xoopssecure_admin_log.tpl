    ...
    <fieldset>
        <div class="mb-2 d-flex justify-content-between align-items-center">
            ...
            <div id = "xoopssecure_logheader_deletedate">
              <{$lang_log_SCANDATEHUMAN}><a href="javascript:void(0)" data-conftext="<{$lang_log_CONFDELETELOG_TEXT}>" data-logdtime="<{$lang_log_SCANDATEDELETE}>" id="xoopssecureDeleteLog"><i class="fa fa-trash-o fa-lg"></i><{$smarty.const._LOG_XOOPSSECURE_DELETETHISLOG}></a>
            </div>
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              <li class="nav-item active">
                <a id="xoopssecureMenuIF" class="nav-link" href="">
                  <{$smarty.const._LOG_XOOPSSECURE_SCANTYPE_INDEXFILES}> <span class="sr-only"><{$smarty.const._LOG_XOOPSSECURE_SCANTYPE_CURRENTSEL}></span>
                </a>
              </li>
              <li class="nav-item">
                <a id="xoopssecureMenuFP" class="nav-link" href=""><{$smarty.const._LOG_XOOPSSECURE_SCANTYPE_FILEPERMISSIONS}></a>
              </li>
              <li class="nav-item">
                <a id="xoopssecureMenuMALL" class="nav-link" href=""><{$smarty.const._LOG_XOOPSSECURE_SCANTYPE_MALLWARE}></a>
              </li>
              <li class="nav-item">
