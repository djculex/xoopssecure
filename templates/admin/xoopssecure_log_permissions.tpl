<div id="xoopssecure_permissions" style="display:none;">
	<{if count($resFP) gt 0}>
	...
	<div class="xoopssecureIndexFilesIssueContainer">
		...
		<legend>
				...
				<h3 class="xoopssecure_shadow_legend">
					<{$smarty.const._SCAN_XOOPSSECURE_WRONFILEPERMISSION_PAGETITLE}>
				</h3>
				</p>
		</legend>
		...
		<ul class="list-group list-group-light">
		  <{foreach item=arr from=$resFP}>
		  <li class="list-group-item d-flex justify-content-between align-items-left">
			<div class="d-flex align-items-left">
			  
			  <div class="ms-3">
				<p class="fw-bold mb-1"><{$arr.filename}></p>
