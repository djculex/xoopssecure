...
$GLOBALS['xoTheme']->addScript(
    ...
    "
                if (typeof jQuery == 'undefined') {
                    ...
                    XOOPS_URL .
                    "/browse.php?Frameworks/jquery/jquery.js\'></scr' + 'ipt>';            	    
                    document.write(tag);            	    
	            };"
);
...
$modversion['templates'] = [
    // Admin templates
    [
        'file'        => 'xoopssecure_admin_about.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_header.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_index.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_issues.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_stats.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_scanner.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_log.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_clone.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_footer.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_system.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_admin_download.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_download_backups.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_download_downloads.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_log_permissions.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_log_indexfiles.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_log_malware.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_log_codingstandards.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_log_nothinghere.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
    [
        'file'        => 'xoopssecure_log_errors.tpl',
        'description' => '',
        'type'        => 'admin',
    ],
