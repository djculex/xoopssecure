...
use const _AM_XOOPSSECURE_ABOUT_MAKE_DONATION;
use const _AM_XOOPSSECURE_DONATION_AMOUNT;
use const _SUBMIT;
use const PREG_OFFSET_CAPTURE;
use const PREG_SET_ORDER;
use const XOOPS_LICENSE_KEY;
