...
class Mech
{
    ...
    public function testServer(): array
    {
        ...
        $memorylimit = $this->convertToBytes($init['Core']['memory_limit']['local']);// < 16M
    ...
    public function phpInfoArray(): array
    {
        ...
        foreach ($info_lines as $line) {
            ...
            if (preg_match("~<tr><td[^>]+>([^<]*)</td><td[^>]+>([^<]*)</td></tr>~", $line, $val)) {
                ...
                $info_arr[$cat][trim($val[1])] = ["local" => trim($val[2]), "master" => trim($val[3])];
            }
        }
        return $info_arr;
    }
