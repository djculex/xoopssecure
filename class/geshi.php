...
class GeSHi
{
    ...
    public function set_header_type($type)
    {
        ...
        if (
            !in_array(
                $type,
                array(GESHI_HEADER_NONE, GESHI_HEADER_DIV,
     ...
     *                                          numbers that are "fancy", otherwise if
     *                                          boolean then this defines whether the
     *                                          normal styles should be merged with the
