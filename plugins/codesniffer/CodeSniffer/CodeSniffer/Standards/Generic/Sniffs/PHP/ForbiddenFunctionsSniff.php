...
class Generic_Sniffs_PHP_ForbiddenFunctionsSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        $data  = array($function);
        $error = _AM_XOOPSSECURE_CODESNIFFER_USEOFUNCIS;
        if ($this->error === true) {
            $type   = 'Found';
            $error .= _AM_XOOPSSECURE_CODESNIFFER_FORBIDDENWORD;
        } else {
            $type   = 'Discouraged';
            $error .= _AM_XOOPSSECURE_CODESNIFFER_DISCOURAGEDWORD;
        }
        ...
        if ($this->forbiddenFunctions[$pattern] !== null) {
            ...
            $error .= _AM_XOOPSSECURE_CODESNIFFER_USESINSTEAD;
        }
