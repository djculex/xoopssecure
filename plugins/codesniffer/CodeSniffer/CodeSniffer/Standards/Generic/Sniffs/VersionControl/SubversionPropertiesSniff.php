    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($properties as $key => $value) {
            if (isset($properties[$key]) === true
                ...
                $error = _AM_XOOPSSECURE_CODESNIFFER_UNEXPSUBVPROP;
                $data  = array(
                          $key,
                          $properties[$key],
                         );
            ...
            if (isset($properties[$key]) === false
                ...
                $error = _AM_XOOPSSECURE_CODESNIFFER_MISSSUBVPROP;
                $data  = array(
                          $key,
                          $this->properties[$key],
                         );
            ...
            if ($properties[$key] !== null
                ...
                $error = _AM_XOOPSSECURE_CODESNIFFER_SUBVPROPDNM;
                $data  = array(
                          $key,
                          $properties[$key],
                          $this->properties[$key],
    ...
    protected function getProperties($path)
    {
        ...
        foreach ($paths as $path) {
            if (file_exists($path) === true) {
                ...
                $handle = fopen($path, 'r');
                if ($handle === false) {
                    $error = _AM_XOOPSSECURE_CODESNIFFER_ERROPFICNGSUBVPROP;
