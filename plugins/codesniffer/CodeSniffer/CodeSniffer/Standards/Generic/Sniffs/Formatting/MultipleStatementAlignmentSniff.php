        ...
        */
        ...
        foreach ($assignments as $assignment) {
            ...
            if ($tokens[$assignment]['column'] !== $actualColumn) {
                ...
                $expected .= ($expected === 1) ? _AM_XOOPSSECURE_CODESNIFFER_SPACE : _AM_XOOPSSECURE_CODESNIFFER_SPACES;
                if ($found === null) {
                    $found = _AM_XOOPSSECURE_CODESNIFFER_NLT;
                } else {
                    $found .= ($found === 1) ? _AM_XOOPSSECURE_CODESNIFFER_SPACE : _AM_XOOPSSECURE_CODESNIFFER_SPACES;
                }

                if (count($assignments) === 1) {
                    $type  = 'Incorrect';
                    $error = _AM_XOOPSSECURE_CODESNIFFER_ESNACEF;
                } else {
                    $type  = 'NotSame';
                    $error = _AM_XOOPSSECURE_CODESNIFFER_ESNAWSAEBF;
                }
