...
<style type="text/css">
	...
	.filelistheader {text-align: center;font-size: 18px;font-weight: bold;}
	.filelisttable {font-size: 11px;max-width: 95%;border: 1px solid darkcyan;padding: 0 15%;background-color: white;overflow: scroll;width: 95%;line-break: anywhere;font-family: Consolas;}
 </style>
</head>
<body>
<!-- Begin Wrapper -->
